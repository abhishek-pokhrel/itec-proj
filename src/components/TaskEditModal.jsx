...
import { X, Save, Trash2, Calendar, Flag, ChevronDown } from 'lucide-react'
...
export default function TaskEditModal({ task, onClose, onSave, onDelete }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="w-full max-w-2xl mx-4 bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-white via-blue-50 to-white border-b border-slate-200 px-8 py-6 flex items-center justify-between">
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="border-b border-slate-200 pb-6">
            <button
              ...
              className="flex items-center justify-between w-full mb-4 font-semibold text-slate-900 hover:text-slate-700"
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-300 resize-none"
                    rows="4"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-2 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-300"
                    >
